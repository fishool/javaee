...
import com.ijavac.springcloud.service.FlowLimitService;
...
//        }
    ...
    // 测试链路流控模式
    @GetMapping("/testLinkA")
    public CommonResult testLinkA(){
        return flowLimitService.getCommonResult();
    }
    // 测试链路流控模式
    @GetMapping("/testLinkB")
    public CommonResult testLinkB(){
        log.info(Thread.currentThread().getName() + "...testB ");
        return flowLimitService.getCommonResult();
    }
...
//        int age = 10 /0;
    ...
    public String dealTestHotKey(String p1, String p2, BlockException blockException){
        return "dealTestHotKey---------5555555555555";
    }
}
